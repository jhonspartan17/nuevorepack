	...
	$(document).on('submit', '#contactform', function() {
		$.ajax({
			...
			success : function(data) {
				if (data == true) {
					$('.form-respond').html("<div class='content-message'> <i class='fa fa-rocket fa-4x'></i> <h2>El correo enviado</h2> <p>Su mensaje es logramos.</p> </div>");
				} else {
					$('.form-respond').html("<div class='content-message'> <i class='fa fa-times fa-4x'></i> <h2>El envío de correo electrónico de error</h2> <p>Por favor, inténtelo de nuevo más tarde o reportar el problema por teléfono.</p> </div>");
				}
			},
			error : function(xhr, err) {
				$('.form-respond').html("<div class='content-message'> <i class='fa fa-times fa-4x'></i> <h2>error técnico</h2> <p>Try again later.</p> </div>");
			}
		});
		return false;
	});
